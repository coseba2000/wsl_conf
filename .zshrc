...
# Setting path of font installation directory
set guifont=/home/sebastien/.local/share/fonts
...
# DISABLE beep sound (when using tab key in zshell)
unsetopt BEEP
...
zmodload zsh/complist
 ...
 # My own custom from default theme
ZSH_THEME="robbyCustom/robbyCustom"
# ZSH_THEME="robbyrussell"
 ...
 # ALIAS
alias desk='cd /mnt/c/Users/Sébastien/Desktop'
alias tmux.a='tmux attach'
alias 1BI='cd /mnt/c/Users/Sébastien/Documents/1IG'
alias 2BI='cd /mnt/c/Users/Sébastien/Documents/2IG'
alias _pyJupyter='cd /mnt/c/Users/Sébastien/Documents/2IG/MATH/python/jupyter_notebook'
alias PROG_OTHER='cd /mnt/c/Users/Sébastien/Documents/PROG_OTHER'

# OPEN TMUX directly
if [ -z "$TMUX" ]; then
	echo 'Open TMUX? [y/n] : ' && read tRun

	if [ "$tRun" = 'y' ]; then
		tmux attach -t zsh || tmux new -s zsh
		 ZSH_THEME="random"
	fi
fi
